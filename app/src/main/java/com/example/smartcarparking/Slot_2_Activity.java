...
public class Slot_2_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        inputSlotNumber.setText("Booked Slot 2");
        ...
        backBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(Slot_2_Activity.this, Booking_Activity.class));
                finish();
            }
        });
            ...
            public void onClick(View v) {
                ...
                documentReference.collection("Booking_Slot").add(bookingData).addOnSuccessListener(new OnSuccessListener<DocumentReference>() {
                    ...
                    public void onSuccess(DocumentReference documentReference) {
                        progressDialog.cancel();
                        Toast.makeText(Slot_2_Activity.this, "Booked Successful...", Toast.LENGTH_SHORT).show();
                    }
                }).addOnFailureListener(new OnFailureListener() {
                    @Override
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(Slot_2_Activity.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                        progressDialog.cancel();
                    }
                });
            }
